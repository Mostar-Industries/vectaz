...
const ShipmentAnalytics: React.FC<ShipmentAnalyticsProps> = ({ metrics }) => {
  ...
  const statusData = [
    { name: 'Active', value: metrics.shipmentStatusCounts.active },
    { name: 'Completed', value: metrics.shipmentStatusCounts.completed },
    { name: 'Failed', value: metrics.shipmentStatusCounts.failed }
  ];

  // Prepare data for on-time vs delayed chart
  const timelinessData = [
    { name: 'On Time', value: metrics.delayedVsOnTimeRate.onTime },
    { name: 'Delayed', value: metrics.delayedVsOnTimeRate.delayed }
  ];
