...
const SuccessView: React.FC<SuccessViewProps> = ({
  ...
  const generatePDF = () => {
    ...
    // Track vertical position for dynamic content positioning
    let yPosition = 40;
    ...
    if (rfqData.requesterName || rfqData.companyName) {
      ...
      // @ts-ignore - autoTable adds this property to the doc object
    ...
    // Update yPosition after shipment details table
    // @ts-ignore - autoTable adds this property to the doc object
    yPosition = doc.lastAutoTable.finalY + 10;
    ...
    if (rfqData.forwarders && rfqData.forwarders.length > 0) {
      ...
      // Update yPosition after forwarders table
      // @ts-ignore - autoTable adds this property to the doc object
      yPosition = doc.lastAutoTable.finalY + 15;
    } else {
      yPosition += 50; // Add some space if no forwarders
    }
